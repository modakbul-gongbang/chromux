...
assertContains(checks, 'help learnNext nudge', docs.help, 'learnNext');
...
assertContains(checks, 'README learnNext nudge', docs.readme, 'learnNext');
...
assertContains(checks, 'chromux skill learnNext checkpoint', docs.chromuxSkill, 'learnNext');
...
assertContains(checks, 'work skill learnNext checkpoint', docs.workSkill, 'learnNext');
